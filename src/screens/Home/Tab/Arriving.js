...
import { Spacing, Input, Container } from '../../../components';
        ...
        <View style={ArrivingScreenStyles.mapviewstyle}>
          ...
          >
            ...
            <MapViewDirections
              ...
              apikey="ADD_YOUR_API_KEY" // insert your API Key here
              strokeWidth={5}
            ...
            <View style={ArrivingScreenStyles.WhereAreYouBox}>
              ...
              <View style={ArrivingScreenStyles.FlexRow}>
                <View style={ArrivingScreenStyles.width60}>
                  <View style={ArrivingScreenStyles.FlexRow}>
                    ...
                    <View>
                      ...
                      <View style={ArrivingScreenStyles.FlexRow}>
                        <IconF name='car' size={SF(20)} color={Colors.theme_background_topaz} /><Text style={ArrivingScreenStyles.Taxi_Modal}>{t("Taxi_Modal_Name")}</Text>
                      </View>
                    </View>
                  </View>
                </View>
                <View style={ArrivingScreenStyles.width40}>
                  <View style={ArrivingScreenStyles.FlexRow}>
                    <Icon name='star' size={SF(15)} color={Colors.theme_background_topaz} /><Text style={ArrivingScreenStyles.RateStyle}>4.1</Text>
                  </View>
